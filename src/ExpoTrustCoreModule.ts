...
declare class ExpoTrustCoreModule extends NativeModule {
  ...
  signMessage(mnemonic: string, message: string, coinType: number, accountIndex?: number): string;
  signTypedData(mnemonic: string, typedDataJSON: string, coinType: number, accountIndex?: number): string;
